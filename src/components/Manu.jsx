...
const Manu = () => {
    ...
    useGSAP(() => {
        ...
        gsap.fromTo('.details h2', { yPercent: 100, opacity: 0 }, { opacity: 1, yPercent: 0, duration: 1, ease: 'power1.inOut' })
        gsap.fromTo('.details p', { yPercent: 100, opacity: 0 }, { opacity: 1, yPercent: 0, duration: 1, ease: 'power1.inOut' })
    }, [currentIndex])

    const totalCocktails = allCocktails.length

    const goToSlied = (index) => {
        ...
        <section id='menu' aria-labelledby='menu-heading'>
            ...
            <div className="content">
                <div className="arrows">
                    <button className='text-left' onClick={() => goToSlied(currentIndex - 1)}>
                        <span>
                            {prevCocktail.name}
                        </span>
